      ...
      <div className={styles.container}>
        ...
        >
          ...
          <p style={{ fontSize: "24px" }}>
            ...
            select your language, and also select the problem you are submitting
            to.
          </p>
          <p style={{ fontSize: "18px" }}>
            If you try to break the system, or similar, your problem will not be
            graded and you will receive a 0. Make sure your file ends in either
            .py, .java, or .cpp in order for it to be graded.
          </p>
          <br />
          <input
            type="file"
